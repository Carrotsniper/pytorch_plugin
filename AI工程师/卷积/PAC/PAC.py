# code: https://github.com/hkzhang91/ParC-Net
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer3 = self._make_mix_layer(block, 256, layers[2], parc_insert_locs[2], global_kernel_size=14, stride=2,
                                       dilate=replace_stride_with_dilation[1])
        self.layer4 = self._make_mix_layer(block, 512, layers[3], parc_insert_locs[3], global_kernel_size=7, stride=2,
    ...
    def _make_mix_layer(self, block: Type[Union[BasicBlock, Bottleneck]], planes: int, blocks: int, parc_insert_loc: int,
        ...
        for i in range(1, blocks):
            if i < parc_insert_loc:
                ...
                layers.append(ParC_block(self.inplanes, planes, global_kernel_size = global_kernel_size,
...
@register_model
def parc_res50(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> parc_resnet:
